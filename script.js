...
document.getElementById('btn-acompanamiento').onclick = () => {
    hablar("Iniciando modo para acompañar. ¿Deseas escuchar tus recordatorios de hoy?");
};
...
window.onload = () => {
    setTimeout(() => { hablar("Bienvenido a tu aplicación de apoyo DIF Contigo Mayor."); }, 500);
};