...
// ESCUCHA ACTIVA DE COMANDOS Y CONVERSACIÓN
...
function iniciarPlatica() {
    hablar("Hola Rosa María, qué gusto saludarte. Recuerda que " + perfil.cita + ". ¿Quieres que revisemos tus apoyos hoy?");
}
...
function firmarPorVoz() {
    hablar("Por favor, Rosa María, di tu nombre y que aceptas el registro.");
    setTimeout(() => {
        perfil.firmaVoz = true;
        hablar("Firma guardada. Tu código ahora es oficial.");
        generarQR();
    }, 4000);
}
...
function actualizarListaVisual() {
    const list = document.getElementById('lista-programas-voz');
    list.innerHTML = `
